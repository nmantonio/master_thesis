...
def modify_MobileNet(trainable=True):
    original_model = MobileNetV3Small(include_top=False, weights="imagenet", input_shape=(512, 512, 3), include_preprocessing=False)
    
    first_conv_layer_idx = 1
